...
public class QuizActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                        ...
                        Toast.makeText(QuizActivity.this, "Tolong Pilih Salah Satu Jawaban", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void showSolution() {
        ...
        switch (currentQuestion.getAnswerNr()) {
            case 1:
                ...
                textViewQuestion.setText("Jawaban NO 1 Benar");
                break;
            case 2:
                rb2.setTextColor(Color.GREEN);
                textViewQuestion.setText("Jawaban NO 2 Benar");
                break;
            case 3:
    ...
    public void onBackPressed() {
        if (backPressedTime + 2000 > System.currentTimeMillis()) {
            ...
            Toast.makeText(this, "Tekan Sekali lagi Untuk Selesai", Toast.LENGTH_SHORT).show();
        }
